var _3s3sObject = 
{
	...
	//	{host: "www.booking.com", code: "<iframe width='468' height='60' scrolling='no' frameborder='0' name='banner' target='_blank' src='https://www.booking.com?aid=801965;tmpl=banners;size=468x60;lang=en;target_aid=801965;theme=minimal;label=banner'></iframe>"},
		...
		{
			host: "ad.a-ads.com",
			code: "<iframe data-aa='65778' src='//ad.a-ads.com/65778?size=468x60' scrolling='no' style='width:468px; height:60px; border:0px; padding:0;overflow:hidden' allowtransparency='true'></iframe>"
		}
	...
	GetAdCode: function()
	{
		...
		for (var i = 0; i<_3s3sObject.aWhiteADList.length; i++)
		{
			...
			if (window.location.hostname.indexOf("cili.tv") != -1)
			{
				nIndex = 3;
				break;
			}
